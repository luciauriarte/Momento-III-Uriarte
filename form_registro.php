          ...
          <div class="row g-0">
            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-center">
              <div class="card-body text-black" style="text-align: center;">
                 <h2 style="font-size: 40px; font-weight: 500; text-align: center;">Registrate en el sitio</h2>
                  <form action="registro.php" method="post" >
                    <label>Nombre:
                        <input style="text-align: center;" type="text" name="nombre" class="form-control form-control-lg" required placeholder="Juan" />
                      </label><br />
                  <label>Apellido:
                        <input style="text-align: center;" type="text" name="apellido" class="form-control form-control-lg"required placeholder="Perez"/>
                      </label><br />
                      <label>Email:
                        <input style="text-align: center;" type="email" name="email" class="form-control form-control-lg" required placeholder="juanperez@gmail.com" />
                      </label><br />
                      <label>Nombre de usuario:
                        <input style="text-align: center;" name="usuario" type="text" maxlength="12" class="form-control form-control-lg" placeholder="juan10"/>
                      </label><br />
                      <label>Contraseña:
                        <input style="text-align: center;" type="password" name="password" maxlength="12" class="form-control form-control-lg" placeholder="**********" />
                      </label><br /> 
                        <button type="submit" class="btn btn-primary boton" style="border-radius:25px; background:#d5e6ea ; color: black;font-size: 20px; margin-top: 7px ">Registrarse</button>  
                  </form>
