        ...
        <div class="card" style="border-radius: 1rem; background: linear-gradient(180deg, #85c3dd 0%, #d5e6ea 100%)">
          <div class="row g-0">
            <div class="col-md-6 col-lg-5 d-none d-md-block">
              ...
              <source src="img/futurismo.mp4" type="video/mp4">
            </video>
            </div>
            <div class="col-md-6 col-lg-7 d-flex align-items-center">
              <div class="card-body text-black" style="text-align: center;">
                 <h2>Hola, 
                  <?php echo $_SESSION["nombre"]; ?></h2>
                  <p>Gracias por unirte a nuestra página!</p>
                 <button type="submit" class="btn btn-primary boton" style="border-radius:25px; background:#d5e6ea ; color: black;font-size: 20px; margin-top: 7px "> <a href="salir.php">SALIR</a></h2></button>
                 </div>
            </div>
          </div>
        </div>
